            ...
            <form @submit.prevent="login">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input v-model="email" type="text" required class="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Username eingeben" />
              ...
              <div class="mt-8">
                ...
                <div class="relative flex items-center">
                  <input v-model="password" type="password" required class="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Passwort eingeben" />
